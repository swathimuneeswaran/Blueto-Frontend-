...
const Home = () => {
  ...
  return (
    <div className='home_blog'>
      <h1>Blog Posts</h1>
      <h2 style={{color:"white",fontStyle:"italic"}}>To Create a New Blog</h2><br />
      ...
      <ReactPaginate
        previousLabel={<FaArrowLeft />} // Use FontAwesome icon for "previous"
        nextLabel={<FaArrowRight />} // Use FontAwesome icon for "next"
        breakLabel={'...'}
        pageCount={pageCount}
